---
title: Lightsail Power Documentation
description: Everything you need to set up, configure, and get the most out of Lightsail Power — workspace management, analytics, and integrations in one place.
mode: frame
---
...
<div data-product-guide-index className="flex w-full flex-col gap-8 max-w-5xl mx-auto px-4 md:px-8 lg:px-12 py-10 lg:gap-14 lg:py-16">
  <div className="flex max-w-[540px] flex-col gap-2 self-center text-center">
    ...
    <p className="text-balance text-base leading-relaxed tracking-tight text-gray-600 dark:text-gray-400">
      Everything you need to set up, configure, and get the most out of Lightsail Power — workspace management, analytics, and integrations in one place.
    </p>
  </div>
  ...
  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
    <Card
      ...
      size={64}
    >
      <span className="product-guide-feature-card-description">Set up your workspace, invite your team, and manage roles and permissions.</span>
    </Card>
    ...
    >
      ...
      <div className="flex flex-col gap-1">
        ...
        <span className="text-sm leading-relaxed text-gray-600 dark:text-gray-400">
          Connect data sources, build dashboards, and automate report delivery.
        </span>
      </div>
    </a>
    <a
    ...
    >
      ...
      <div className="flex flex-col gap-1">
        ...
        <span className="text-sm leading-relaxed text-gray-600 dark:text-gray-400">
          Ready-to-use connectors for CRMs, messaging tools, and flexible webhooks for event-driven automation.
        </span>
      </div>
    </a>
  </div>
    ...
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
      ...
      >
        ...
        <div className="flex flex-col gap-1">
          ...
          <span className="text-sm leading-relaxed text-gray-600 dark:text-gray-400">
            Link a database, data warehouse, or SaaS tool to start building charts.
          </span>
        </div>
      </a>
      <a
      ...
      >
        ...
        <div className="flex flex-col gap-1">
          ...
          <span className="text-sm leading-relaxed text-gray-600 dark:text-gray-400">
            Deliver recurring data snapshots to your team via email or Slack.
          </span>
        </div>
      </a>
    </div>
